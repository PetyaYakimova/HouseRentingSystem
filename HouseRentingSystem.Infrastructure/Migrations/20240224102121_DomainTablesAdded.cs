        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentId = table.Column<int>(type: "int", nullable: false, comment: "Agnet Identifier"),
                    RenterId = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "User identifier of the renter")
                },
                constraints: table =>
                {
